...
const TripTile = ({ trip, className }: Props) => {
   ...
   return (
      <div
         className={`card sm:card-side shadow-lg opacity-100 bg-base-100 hover:bg-base-200 transition-all duration-300 ease-in-out p-4 mb-4 ${className}`}
      >
         ...
         <div className='ml-2 flex gap-4 sm:gap-0 flex-col sm:flex-row justify-between w-full'>
            <div className='flex flex-col justify-between'>
               <header>
                  <div className='text-[0.7rem]'>Name of our Destination:</div>
                  <h3 className='trip-title ml-4 text-2xl font-bold '>
         ...
         <aside className='absolute bottom-2 right-2'>
            {authRole === 'admin' && (
